    ...
    <div class="container-fluid py-4">
        ...
        <div class="card shadow border-0 rounded-4">
            <div class="card-header bg-gradient-primary text-white rounded-top-4 py-3">
                <h6 class="mb-0 text-white"><i class="fas fa-bolt me-2"></i> Form Tambah SPLN</h6>
            </div>

            <div class="card-body bg-white px-4 py-4">
                <form action="<?= base_url('spln/tambah'); ?>" method="POST" enctype="multipart/form-data">

                    <!-- Nama File -->
                    <div class="mb-3">
                        <label for="NAMA_FILE" class="form-label fw-bold">Nama File SPLN</label>
                        <input type="text" class="form-control border rounded-3" id="NAMA_FILE" name="NAMA_FILE"
                            placeholder="Masukkan nama file SPLN..." required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control border rounded-3" id="CREATED_BY" name="CREATED_BY"
                            placeholder="Masukkan nama pembuat SPLN..." required>
                    </div>

                    <!-- Upload File -->
                    <div class="mb-3">
                        <label for="FILE_SPLN" class="form-label fw-bold">Upload File SPLN</label>
                        <input type="file" class="form-control border rounded-3" id="FILE_SPLN" name="FILE_SPLN"
                    ...
                    <div class="d-flex justify-content-start align-items-center gap-2 mt-4">
                        <a href="<?= base_url('spln'); ?>" class="btn btn-secondary px-4">
