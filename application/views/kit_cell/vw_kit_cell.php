            ...
            <div class="card-body px-0 pt-0 pb-2 bg-white">
                <div class="px-3 mt-3 mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <form method="get" action="<?= base_url('Kit_cell/index'); ?>" class="d-flex align-items-center" onsubmit="event.preventDefault(); searchSubmit('<?= site_url('Kit_cell/index'); ?>', 'searchInputKC', 'q');">
                        ...
                        <?php if (!empty($search)): ?>
                            <button type="button" class="btn btn-sm btn-outline-secondary ms-2" onclick="window.location.replace('<?= base_url('Kit_cell/index?per_page=' . (int)$per_page); ?>')">Reset</button>
                        <?php endif; ?>
                    </form>
                </div>
                                ...
                                foreach ($kit_cell as $row): ?>
                                    <tr class="<?= ($no % 2 == 0) ? 'table-row-even' : 'table-row-odd'; ?>">
                                        ...
                                        <td class="text-center">
                                            <a href="<?= base_url('Kit_cell/detail/' . urlencode($row['SSOTNUMBER'])); ?>" class="btn btn-info btn-xs text-white me-1" title="Detail">
