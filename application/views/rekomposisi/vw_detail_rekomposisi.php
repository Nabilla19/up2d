                        ...
                        <div class="card shadow border-0 rounded-4">
                            <div class="card-header bg-gradient-primary text-white text-center rounded-top-4">
                                <h6 class="mb-0 text-white">
                                    <i class="fas fa-random me-2 text-info"></i> Detail Rekomposisi
                                </h6>
                            </div>
                                    ...
                                    <?php foreach ($fields as $key => $label): ?>
                                        <div class="col-md-6 mb-3">
                                            <div class="detail-item">
                                                ...
                                                <p class="value"><?= htmlspecialchars($rekomposisi[$key] ?? '-'); ?></p>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                            ...
                            <div class="card-footer text-center bg-light border-top">
                                <a href="<?= base_url('rekomposisi'); ?>" class="btn btn-danger px-4">
