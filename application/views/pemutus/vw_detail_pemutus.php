	...
	<section class="section">
		<div class="section-body">
			<div class="container-fluid py-4">
				<h1 class="h3 mb-4 text-gray-800"><?= $title ?? 'Detail Pemutus (LBS - Recloser)'; ?></h1>
						...
						<div class="card shadow border-0 rounded-4">
							<div class="card-header bg-gradient-primary text-white text-center rounded-top-4">
								<h6 class="mb-0 text-white">
									<i class="fas fa-toggle-on me-2 text-white"></i> Detail Pemutus (LBS - Recloser)
								</h6>
							</div>
									...
									?>
										<div class="col-md-6">
											<div class="detail-item">
												...
												<p class="value"><?= htmlspecialchars($pemutus[$key] ?? '-', ENT_QUOTES, 'UTF-8'); ?></p>
											</div>
										</div>
									<?php
										if ($i % 2 == 1) echo '</div>';
							...
							<div class="card-footer text-center bg-light border-top">
								<a href="<?= base_url('Pemutus') ?>" class="btn btn-danger px-4">
