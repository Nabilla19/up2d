    ...
    <div class="container-fluid py-4">
        ...
        <div class="card shadow border-0 rounded-4">
            ...
            <div class="card-body bg-white px-4 py-4">
                <form action="<?= base_url('ik/tambah'); ?>" method="POST" enctype="multipart/form-data">

                    <!-- Nama File -->
                    <div class="mb-3">
                        <label for="NAMA_FILE" class="form-label fw-bold">Nama File IK</label>
                        <input type="text" class="form-control border rounded-3" id="NAMA_FILE" name="NAMA_FILE"
                            placeholder="Masukkan nama file IK..." required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control border rounded-3" id="CREATED_BY" name="CREATED_BY"
                            placeholder="Masukkan nama pembuat IK..." required>
                    </div>

                    <!-- Upload File -->
                    <div class="mb-3">
                        <label for="FILE_IK" class="form-label fw-bold">Upload File IK</label>
                        <input type="file" class="form-control border rounded-3" id="FILE_IK" name="FILE_IK"
                    ...
                    <div class="d-flex justify-content-start align-items-center gap-2 mt-4">
                        <a href="<?= base_url('ik'); ?>" class="btn btn-secondary px-4">
