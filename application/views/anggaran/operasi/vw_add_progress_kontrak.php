    ...
    <div class="container-fluid py-4">
        <div class="card shadow border-0 rounded-4">
            <div class="card-header bg-gradient-primary text-white">
                <h6 class="mb-0 text-white"><i class="fas fa-file-contract me-2"></i>Form Tambah Data Progress Kontrak Operasi</h6>
            </div>

            <div class="card-body">
                <form id="addProgressKontrakOpForm" action="<?= base_url('anggaran/operasi/store_progress_kontrak'); ?>" method="POST">
                    <div class="row g-3">
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <a href="<?= base_url('anggaran/operasi/progress_kontrak'); ?>" class="btn btn-secondary">
