...
class Investasi extends CI_Controller {
    ...
    {
        $this->load->view('layout/header');
        $this->load->view('anggaran/investasi/vw_add_progress_kontrak');
        $this->load->view('layout/footer');
    }
    ...
    public function store_progress_kontrak()
    {
        ...
        $insert = $this->db->insert('anggaran_inv', $data);

        if ($insert) {
            $this->session->set_flashdata('success', 'Data progress kontrak investasi berhasil ditambahkan!');
        } else {
            $this->session->set_flashdata('error', 'Gagal menambahkan data progress kontrak investasi!');
        }

        redirect('anggaran/investasi/progress_kontrak');
    }

    public function add_rekomposisi()
    {
        $this->load->view('layout/header');
        $this->load->view('anggaran/investasi/vw_add_rekomposisi');
        $this->load->view('layout/footer');
    }
    ...
    public function store_rekomposisi()
    {
        ...
        $insert = $this->db->insert('rekomposisi_inv', $data);

        if ($insert) {
            $this->session->set_flashdata('success', 'Data rekomposisi investasi berhasil ditambahkan!');
        } else {
            $this->session->set_flashdata('error', 'Gagal menambahkan data rekomposisi investasi!');
        }

        redirect('anggaran/investasi/rekomposisi');
    }

    public function add_monitoring()
    {
        $this->load->view('layout/header');
        $this->load->view('anggaran/investasi/vw_add_monitoring');
        $this->load->view('layout/footer');
    }
    ...
    public function store_monitoring()
    {
        ...
        $insert = $this->db->insert('monitoring_inv', $data);

        if ($insert) {
            $this->session->set_flashdata('success', 'Data monitoring investasi berhasil ditambahkan!');
        } else {
            $this->session->set_flashdata('error', 'Gagal menambahkan data monitoring investasi!');
        }

        redirect('anggaran/investasi/monitoring');
    }
